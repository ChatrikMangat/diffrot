...
0.1   entc_min : initial central enthalpy [c^2]
1.0   entc_max : initial central enthalpy [c^2]
2000.0 	freq_min_si : initial central rotation frequency [Hz]
2000.0 	freq_max_si : final central rotation frequency [Hz]
100	Number of configurations in the sequence
...
2.80     Requested baryon mass [M_sol] (effective only if mer_mass < mer_max)
#################### COMPUTATIONAL PARAMETERS #################################
1200     mer_max : maximum number of steps
8.e-6  precis : threshold on the enthalpy relative change for ending the computation
0.3     thres_adapt : threhold on (dH/dr_eq)/dH/dr_pole) for the mapping adaptation
10000       mer_mass : step from which the baryon mass is forced to converge
